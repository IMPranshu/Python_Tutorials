...
spam = {123:'Luggage COmbination',42:'The Answers'}
spam[123]
...
picnic={'apples':5,'cups':6}
print('I am bringing ' + str(picnic.get('apples',0)) + ' apples' +       ' & ' + str(picnic.get('cups',0)) + ' cups' +         ' & ' + str(picnic.get('oranges',0)) + ' oranges')
